...
namespace AUTOHARVEST
{
    ...
    public class AUTOHARVEST : IPlugin, IDisposable
    {
        //-------[ Plugin metadata ]-------

        // >>> Make sure you rename BOTH the namespace and class (Very important)
        public string Description => "Harvest corruptions automatically";
        ...
        public string Name => nameof(AUTOHARVEST).Replace("_"," ");
